...
$g->table = "procedencias";
$g->select_command = "SELECT * FROM procedencias";

$g->set_columns($cols,true);
$g->set_options($grid);

$out = $g->render("listprocedencias");
...
<body>
	<title>Listado de Procedencias</title>
    <div>
    <?php echo $out?>
    </div>
</body>
