...
$grid["rowNum"] = 10;
$grid["caption"] = "Proceso de Inscripcion";
$grid["autowidth"] = true;
$grid["sortable"] = true;
//$grid["rownumWidth"] = 35;
$grid["forceFit"] = true;
...
$g->table = "procinscripcionview";
$g->select_command = "SELECT idalumno, idgrupo, idinscripcion, ciescolar, nombres, apellidos FROM procinscripcionview";
...
<body>
	<title>Proceso de Inscripcion</title>
    <div>
    <?php echo $out?>
    </div>
</body>
