...
$grid["sortname"] = 'id';
$grid["rowNum"] = 10;
$grid["caption"] = "Datos de Habitacion";
$grid["autowidth"] = true;
$grid["sortable"] = true;
//$grid["rownumWidth"] = 35;
$grid["forceFit"] = true;
...
$g->table = "datos_habitacion";
$g->select_command = "SELECT * FROM datos_habitacion";

$g->set_columns($cols,true);
$g->set_options($grid);

$out = $g->render("listdatos_habitacion");
...
<body>
	<title>Listado de Datos de Habitacion</title>
    <div>
    <?php echo $out?>
    </div>
</body>
